...
class FLIGHT:
	def __init__(self,root):
		...
		con.commit()
		values=[('KOLKATA','MUMBAI'),('KOLKATA','DELHI'),('MUMBAI','DELHI'),('MUMBAI','KOLKATA'),('DELHI','MUMBAI'),('DELHI','KOLKATA')]
		...
		Mainframe=Frame(self.root,bd=20,width=700,height=700,relief=RIDGE)
		Mainframe.grid()
		...
		self.label=Label(Mainframe,text="EMERALD AIRLINES",font=("Helvetica",22))
		self.label.grid(row=0,column=0,columnspan=2)

		self.button1=Button(Mainframe,text="ROUND TRIP",font=("Helvetica",18),width=15,command=lambda :clickme(self.button1))
		self.button1.grid(row=1,column=0,padx=20,pady=10)

		self.button2=Button(Mainframe,text="ONEWAY TRIP",font=("Helvetica",18),width=15,command=lambda :clickme(self.button2))
		self.button2.grid(row=1,column=1,padx=20,pady=10)

		self.origin_label=Label(Mainframe,text="ORIGIN",font=("Helvetica",18))
		self.origin_label.grid(row=2,column=0,padx=5,pady=5,sticky=W)

		self.destination_label=Label(Mainframe,text="DESTINATION",font=("Helvetica",18))
		self.destination_label.grid(row=3,column=0,padx=5,pady=5,sticky=W)

		self.depart_label=Label(Mainframe,text="DEPART",font=("Helvetica",18))
		self.depart_label.grid(row=4,column=0,padx=5,pady=5,sticky=W)

		self.return_label=Label(Mainframe,text="RETURN",font=("Helvetica",18))
		self.return_label.grid(row=5,column=0,padx=5,pady=5,sticky=W)

		self.passangers_label=Label(Mainframe,text="PASSANGERS",font=("Helvetica",18))
		self.passangers_label.grid(row=6,column=0,padx=5,pady=5,sticky=W)

		self.adult_label= Label(Mainframe, text="ADULT",font=("Helvetica",12))
		self.adult_label.grid(row=6,column=0,padx=5,pady=5,sticky=E)

		self.child_label=Label(Mainframe,text="CHILD",font=("Helvetica",12))
		self.child_label.grid(row=7,column=0,padx=5,pady=5,sticky=E)

		self.class_label=Label(Mainframe,text='CLASS',font=("Helvetica",18))
		...
		self.depart_button=Button(Mainframe,text="⬆",command=lambda :get_date(self.depart_button))
		...
		self.return_button=Button(Mainframe,text="⬆",command=lambda :get_date(self.return_button))
		...
		self.adult0 = Button(Mainframe, text="+", command=clicked0)
		self.adult0.grid(row=6,column=2,padx=5,pady=5,sticky=W)

		self.adult1=Button(Mainframe, text="-", command=clicked1)
		self.adult1.grid(row=6,column=1,padx=5,pady=5,sticky=W)

		self.child0=Button(Mainframe, text="+", command=click0)
		self.child0.grid(row=7,column=2,padx=5,pady=5,sticky=W)

		self.child0=Button(Mainframe, text="-", command=click1)
		...
		def submit_d():
			...
			def Yes():
				...
				bb7=Button(Leftframe,text='SUBMIT',command=submm)
				bb7.grid(row=9,column=0)
                                
				T = Text(self.mast, height=5, width=50)
				T.grid(row=1,column=5,rowspan=6)
		...
		def treeview():
			...
			Rightframe=Frame(self.root2,bd=20,width=700,height=700,relief=RIDGE)
			Rightframe.grid()
			self.name_label = Label(Rightframe, text="NAME :")
			self.name_entry = Entry(Rightframe)
			self.name_entry.insert(END,'FULL NAME')
			self.name_label.grid(row=0, column=0, sticky=W)
			self.name_entry.grid(row=0, column=1)

			self.adnumber_label = Label(Rightframe, text="AADHAR NO :")
			...
			self.submit_details=Button(Rightframe,text='SUBMIT',command=submit_d)
		...
		def search():
			self.root1=Tk()
			self.root1.geometry("625x525")
			self.root1.title("EMERALD AIRLINES")
			Leftframe=Frame(self.root1,bd=20,width=800,height=800,relief=RIDGE)
			Leftframe.grid()
			self.l0=Label(Leftframe, text="Choose your flight",font=("Arial bold",15))
			self.l0.grid(row=0, column=0,padx=10)
			
			self.l00=Label(Leftframe,text="Flight Timings",font=("Arial bold",10))
			self.l00.grid(row=1,column=0, padx=10, pady=20)
			self.l01=Label(Leftframe,text="Price(In ₹)",font=("Arial bold",10))
			self.l01.grid(row=1,column=1,padx=20,pady=20)
			
			self.l1=Label(Leftframe,text="07:00 → 09:00")
			self.l1.grid(row=2,column=0, padx=10, pady=20)
			self.p1=Entry(Leftframe,font=("Arial bold",10))
			self.p1.insert(END,'5000')
			self.p1.grid(row=2,column=1)
			self.b1=Button(Leftframe,text='✓',command=lambda: clickedme(self.b1))
			self.b1.grid(row=2,column=2)
			
			self.l2=Label(Leftframe,text="08:30 → 10:30")
			self.l2.grid(row=3,column=0, padx=10, pady=20)
			self.p2=Entry(Leftframe,font=("Arial bold",10))
			self.p2.insert(END,"5900")
			self.p2.grid(row=3,column=1)
			self.b2=Button(Leftframe,text='✓',command=lambda: clickedme(self.b2))
			self.b2.grid(row=3,column=2)
			
			self.l3=Label(Leftframe,text="11:00 → 13:00")
			self.l3.grid(row=4,column=0, padx=10, pady=20)
			self.p3=Entry(Leftframe,font=("Arial bold",10))
			self.p3.insert(END,"7640")
			self.p3.grid(row=4,column=1)
			self.b3=Button(Leftframe,text='✓',command=lambda: clickedme(self.b3))
			self.b3.grid(row=4,column=2)
			
			self.l4=Label(Leftframe,text="13:40 → 15:45")
			self.l4.grid(row=5,column=0, padx=10, pady=20)
			self.p4=Entry(Leftframe,font=("Arial bold",10))
			self.p4.insert(END,"8500")
			self.p4.grid(row=5,column=1)
			self.b4=Button(Leftframe,text='✓',command=lambda: clickedme(self.b4))
			self.b4.grid(row=5,column=2)
			
			self.l5=Label(Leftframe,text="18:40 → 20:40")
			self.l5.grid(row=6,column=0, padx=10, pady=20)
			self.p5=Entry(Leftframe,font=("Arial bold",10))
			self.p5.insert(END,"9600")
			self.p5.grid(row=6,column=1)
			self.b5=Button(Leftframe,text='✓',command=lambda: clickedme(self.b5))
			self.b5.grid(row=6,column=2)
			
			hello(self.class_combo1.get())

			self.submit=Button(Leftframe,text='SUBMIT',command=subm)
		...
		self.submit=Button(Mainframe,text="SUBMIT",font=('Helvetica',18),width=15,command=submit)
		self.submit.grid(row=9,column=0,sticky=W)
...
#l0=Label(root,text="YOUR BILL",font=("Arial bold",15))
#l0.grid(row=0,column=0,padx=70)
#T=Text(root,height=20,width=30)
#T.grid(row=2,column=0,padx=70)
#if b==b1:
    
 #   quote="Passenger's Name:"
